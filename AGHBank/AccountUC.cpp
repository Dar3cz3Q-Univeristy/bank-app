...
System::Void AccountUC::AccountUC_Load(System::Object^ sender, System::EventArgs^ e) {
	try {
		...
		if (reader->Read()) {
			...
			if (genderCheck % 2 == 0) {
				personPictureBox->Image = (cli::safe_cast<System::Drawing::Image^>(gcnew Bitmap("C:\\Users\\dariu\\Documents\\Programowanie\\Podstawy Informatyki\\Projekt\\Aplikacja\\women.png")));
			}
		}
