...
# Installation
## By installer
Download [AGHBank.zip](https://www.mediafire.com/file/91efbe3atwh8a9x/AGHBank.zip/file) file, unzip it and run "setup.exe". Follow the steps shown on the screen. Program will use prepared online MSSQL database (free tier so it's not the fastest one).
